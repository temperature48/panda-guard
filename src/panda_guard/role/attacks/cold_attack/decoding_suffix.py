...
def decode(model, tokenizer, device, x="", z="", constraints=None, args=None, sys_prompt=None, prefix=None, model_back=None, zz=None):
    ...
    for iter in range(args.num_iters):
        ...
        if args.verbose and ((iter + 1) % args.logging.info_every == 0 or iter == 0 or iter + 1 == args.num_iters):
            ...
            for bi in range(args.batch_size):
                ...
                logging.info(tokenizer.decode(output_ids[0], skip_special_tokens=True))
                logging.info(
