...
def run_model_inference(model_name, model_value, eval_set, attack_names, llm_gen_config, ctrl_factors, batch_size,
    ...
    for attack_name in attack_names:
        ...
        for ctrl_factor in ctrl_factors:
            ...
            output_file = os.path.join(output_base_dir, f'TransferAttack_{attack_name}_full_{ctrl_factor:.3f}.json')
            print(output_file)
