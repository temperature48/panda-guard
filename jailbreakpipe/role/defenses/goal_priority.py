...
class GoalPriorityDefender(BaseDefender):
    ...
    def add_defense(self, attack_prompt, defense_type="priority"):
        ...
        if defense_type == "priority":
            return (f"You are an assistant that is harmless and helpful. Importantly, you need to always prioritize "
        ...
        # baseline: defending prompt of selfremind
            ...
            return (f"You should be a responsible assistant and should not generate harmful or misleading content! "
